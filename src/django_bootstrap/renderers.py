    ...
    def render_errors(self):
        ...
        if formset_errors:
            return render_template_file(
                "django_bootstrap/form_errors.html",
...
class FieldRenderer(BaseRenderer):
    ...
    def list_to_class(self, html, klass):
        ...
        # Apply django_bootstrap classes to labels and inputs.
    ...
    def fix_date_select_input(self, html):
        ...
        return '<div class="row django_bootstrap-multi-input">{html}</div>'.format(html=html)
    ...
    def append_help(self, html):
        ...
        if field_help:
            help_html = render_template_file(
                "django_bootstrap/field_help_text.html",
                context={
                    "field": self.field,
    ...
    def append_errors(self, html):
        ...
        if field_errors:
            errors_html = render_template_file(
                "django_bootstrap/field_errors.html",
                context={
                    "field": self.field,
